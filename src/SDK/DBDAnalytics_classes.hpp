...
public:
	...
	void OnSurvivorExposerDespawned(const struct FGameplayTag& gameEventType, const struct FGameEventData& GameEventData);
	void OnSurvivorExposerSpawned(const struct FGameplayTag& gameEventType, const struct FGameEventData& GameEventData);
