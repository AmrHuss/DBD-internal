...
public:
	...
	class UMoviePipelineCustomTimeStep*           CustomTimeStep;                                    // 0x0060(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_68[0x10];                                      // 0x0068(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEngineCustomTimeStep*                  CachedPrevCustomTimeStep;                          // 0x0078(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ULevelSequence*                         TargetSequence;                                    // 0x0080(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x0088(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieRenderDebugWidget*                DebugWidget;                                       // 0x0090(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTexture*                               PreviewTexture;                                    // 0x0098(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A0[0x288];                                     // 0x00A0(0x0288)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TSoftObjectPtr<class UMoviePipelineConfigBase> ConfigOrigin;                                     // 0x0050(0x0038)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class UMoviePipeline*                         ActiveMoviePipeline;                               // 0x0128(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	TMap<class FString, class UMoviePipelineShotConfig*> PerShotConfigMapping;                       // 0x0090(0x0050)(ExportObject, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	class UMoviePipelineOutputSetting*            OutputSetting;                                     // 0x00E0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMoviePipelineSetting*>          TransientSettings;                                 // 0x00E8(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_68[0xA8];                                      // 0x0068(0x00A8)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Progress;                                          // 0x0110(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_114[0x4];                                      // 0x0114(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 StatusMessage;                                     // 0x0118(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoviePipelineShotConfig*               ShotOverrideConfig;                                // 0x0128(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMoviePipelineShotConfig> ShotOverridePresetOrigin;                         // 0x0130(0x0038)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TSoftObjectPtr<class UMoviePipelinePrimaryConfig> PresetOrigin;                                  // 0x00F0(0x0038)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TSoftObjectPtr<class UMoviePipelineQueue>     QueueOrigin;                                       // 0x0040(0x0038)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
// 0x0000 (0x0050 - 0x0050)
class UMoviePipelineRenderPass final : public UMoviePipelineSetting
{
public:
	static class UClass* StaticClass()
	{
