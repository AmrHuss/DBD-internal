...
public:
	...
	bool SetCustomGlobalTransform(const struct FTransform& AttributeValue);
...
// Class InterchangeFactoryNodes.InterchangeCineCameraFactoryNode
// 0x0030 (0x0198 - 0x0168)
class UInterchangeCineCameraFactoryNode final : public UInterchangeActorFactoryNode
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InterchangeCineCameraFactoryNode">();
	}
	static class UInterchangeCineCameraFactoryNode* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInterchangeCineCameraFactoryNode>();
	}
};
...
{
public:
	uint8                                         Pad_140[0x1F0];                                    // 0x0140(0x01F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_330[0x90];                                     // 0x0330(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_140[0x210];                                    // 0x0140(0x0210)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool RemoveAnimatedMorphTargetDependencyUid(const class FString& DependencyUid);
	...
	bool SetAnimatedMorphTargetDependencyUid(const class FString& DependencyUid);
	...
	void GetAnimatedMorphTargetDependencies(TArray<class FString>* OutDependencies) const;
	void GetAnimatedMorphTargetDependency(const int32 Index_0, class FString* OutDependency) const;
	...
	class UClass* GetObjectClass() const;
	void GetSceneNodeAnimationPayloadKeys(TMap<class FString, class FString>* OutSceneNodeAnimationPayloads) const;
...
{
public:
	uint8                                         Pad_270[0x98];                                     // 0x0270(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
