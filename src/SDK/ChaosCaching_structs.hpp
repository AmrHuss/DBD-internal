...
public:
	...
	struct FSoftComponentReference                SoftComponentRef;                                  // 0x0040(0x0060)(Edit, NativeAccessSpecifierPublic)
	bool                                          bIsSimulating;                                     // 0x00A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A1[0x1];                                       // 0x00A1(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bPlaybackEnabled;                                  // 0x00A2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A3[0xED];                                      // 0x00A3(0x00ED)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
