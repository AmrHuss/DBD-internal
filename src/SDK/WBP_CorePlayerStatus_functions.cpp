...
// Parameters:
// const EConnectionQuality&               connectionQuality                                      (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_CorePlayerStatus_C::UpdatePlayerPortraitIconSize(bool IsCalamariMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CorePlayerStatus_C", "UpdatePlayerPortraitIconSize");

	Params::WBP_CorePlayerStatus_C_UpdatePlayerPortraitIconSize Parms{};
...
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TSoftObjectPtr<class UTexture2D>& activityIcon_0                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash)
// const bool                              ShouldDisplayProgress                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_CorePlayerStatus_C::ShowSurvivorActivity(const TSoftObjectPtr<class UTexture2D>& activityIcon_0, const bool ShouldDisplayProgress)
{
	static class UFunction* Func = nullptr;
	...
	Parms.activityIcon_0 = activityIcon_0;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FPlayerStatusViewData&     Data                                                   (BlueprintVisible, BlueprintReadOnly, Parm)
...
// bool                                    HasSpecialHookStrike                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_CorePlayerStatus_C::SetHookStrikeVisual(class UDBDImage* HookStrikeImage, bool IsOn, bool HasSpecialHookStrike, bool shouldAnimate)
{
	static class UFunction* Func = nullptr;
	...
	Parms.IsOn = IsOn;
	Parms.HasSpecialHookStrike = HasSpecialHookStrike;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TSoftObjectPtr<class UTexture2D>        ClassIcon_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, UObjectWrapper, HasGetValueTypeHash)
// const bool                              IsCalamariMode                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_CorePlayerStatus_C::SetClassIcon(TSoftObjectPtr<class UTexture2D> ClassIcon_0, const bool IsCalamariMode, bool Is_Player_Killer, bool Is_Local_Player_Killer)
{
	static class UFunction* Func = nullptr;
...
// bool                                    IsLocalPlayerKiller                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    HasSpecialHookDrainStage                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_CorePlayerStatus_C::Set_Hooked_Count(int32 drainStage, bool IsLocalPlayerKiller, bool HasSpecialHookDrainStage)
{
	static class UFunction* Func = nullptr;
	...
	Parms.HasSpecialHookDrainStage = HasSpecialHookDrainStage;
...
void UWBP_CorePlayerStatus_C::Player_Injured_Idle_Animation(int32 Loops, class UWidgetAnimation** Animation)
{
	static class UFunction* Func = nullptr;
...
void UWBP_CorePlayerStatus_C::OnRevealHIghlightCompleted(class UUITweenInstance* tween)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CorePlayerStatus_C", "OnRevealHIghlightCompleted");

	Params::WBP_CorePlayerStatus_C_OnRevealHIghlightCompleted Parms{};
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const bool                              isChased                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const bool                              disableLeftClaw                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const bool                              disableRightClaw                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_CorePlayerStatus_C::AnimateHookStrike(class UMaterialInstanceDynamic* DynamicMaterial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CorePlayerStatus_C", "AnimateHookStrike");

	Params::WBP_CorePlayerStatus_C_AnimateHookStrike Parms{};
