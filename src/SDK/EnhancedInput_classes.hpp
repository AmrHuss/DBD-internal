...
public:
	...
	TMulticastInlineDelegate<void()>              ControlMappingsRebuiltDelegate;                    // 0x01D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
