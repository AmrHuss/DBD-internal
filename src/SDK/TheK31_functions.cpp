...
void IK31FXInterface::Cosmetic_TriggerSurvivorAppearOnRadarEvent()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("K31FXInterface", "Cosmetic_TriggerSurvivorAppearOnRadarEvent");
...
// Parameters:
// const TArray<class ASurvivor*>&         survivorsToScream                                      (ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UK31P02::Multicast_MakeSurvivorsScream(const TArray<class ASurvivor*>& survivorsToScream)
{
	static class UFunction* Func = nullptr;
	...
	Params::K31P02_Multicast_MakeSurvivorsScream Parms{};

	Parms.survivorsToScream = std::move(survivorsToScream);
...
void UK31SurvivorClawTrapComponent::Authority_OnDamageStateChanged(EHealthState oldDamageState, EHealthState newDamageState)
{
	static class UFunction* Func = nullptr;
...
void UK31SurvivorClawTrapComponent::OnSurvivorEscaped(const struct FGameplayTag& gameEventType, const struct FGameEventData& GameEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("K31SurvivorClawTrapComponent", "OnSurvivorEscaped");

	Params::K31SurvivorClawTrapComponent_OnSurvivorEscaped Parms{};
...
void UK31SurvivorDetection::Authority_OnDamageStateChanged(EHealthState oldDamageState, EHealthState newDamageState)
{
	static class UFunction* Func = nullptr;
...
void USurvivorHackDroneInteraction::Authority_OnMinigameEnd(class ASurvivor* Survivor, EDirectionalMinigameResult Result)
{
	static class UFunction* Func = nullptr;
...
void USurvivorRemoveClawTrapInteraction::Authority_OnMinigameEnd(class ASurvivor* Survivor, EDirectionalMinigameResult Result)
{
	static class UFunction* Func = nullptr;
