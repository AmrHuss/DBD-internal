...
// Function AkAudio.AkAudioEvent.IsLoaded
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UAkAudioEvent::IsLoaded() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkAudioEvent", "IsLoaded");

	Params::AkAudioEvent_IsLoaded Parms{};
...
// Function AkAudio.AkEGSInitializationSettings.MigrateMultiCoreRendering
// (Final, Native, Public)
// Parameters:
// bool                                    NewValue                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAkEGSInitializationSettings::MigrateMultiCoreRendering(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AkEGSInitializationSettings", "MigrateMultiCoreRendering");

	Params::AkEGSInitializationSettings_MigrateMultiCoreRendering Parms{};
