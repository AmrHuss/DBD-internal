...
{
public:
	struct FConstraintTickFunction                ConstraintTick;                                    // 0x0030(0x0040)(NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector                                OffsetTranslation;                                 // 0x00A0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FFilterOptionPerAxis                   AxisFilter;                                        // 0x00B8(0x0003)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                OffsetScale;                                       // 0x00A0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FFilterOptionPerAxis                   AxisFilter;                                        // 0x00B8(0x0003)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_BB[0x5];                                       // 0x00BB(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FVector                                Axis;                                              // 0x0098(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
