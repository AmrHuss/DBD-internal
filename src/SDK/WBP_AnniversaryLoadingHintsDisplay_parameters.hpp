...
struct WBP_AnniversaryLoadingHintsDisplay_C_ExecuteUbergraph_WBP_AnniversaryLoadingHintsDisplay final
{
public:
...
struct WBP_AnniversaryLoadingHintsDisplay_C_OnFadeInComplete final
{
public:
...
// 0x0008 (0x0008 - 0x0000)
struct WBP_AnniversaryLoadingHintsDisplay_C_OnFadeOutComplete final
{
public:
	class UUITweenInstance*                       tween;                                             // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
struct WBP_AnniversaryLoadingHintsDisplay_C_PreConstruct final
{
public:
...
struct WBP_AnniversaryLoadingHintsDisplay_C_StartFadeSequence final
{
public:
