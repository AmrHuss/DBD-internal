...
// 0x0540 (0x0638 - 0x00F8)
class UMovieSceneAudioSection final : public UMovieSceneSection
{
public:
	class USoundBase*                             Sound;                                             // 0x00F8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x04C8(0x0128)(NativeAccessSpecifierPrivate)
	...
	TDelegate<void(const TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles; // 0x0600(0x0014)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_614[0x4];                                      // 0x0614(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x0618(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(const class USoundWave* PlayingSoundWave, const float PlaybackPercent)> OnAudioPlaybackPercent; // 0x0628(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x00F8(0x0140)(NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x0100(0x0140)(NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimationParams     params;                                            // 0x0100(0x0150)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	class UWeightAndEasingEvaluatorSystem*        EvaluatorSystem;                                   // 0x0080(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<class UMovieSceneSection*>             AudioSections;                                     // 0x00A8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	uint8                                         Pad_D8[0x8];                                       // 0x00D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UObject>                    PropertyClass;                                     // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
