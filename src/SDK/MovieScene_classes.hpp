...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x02B0(0x0020)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	struct FMovieSceneSectionParameters           Parameters;                                        // 0x0100(0x0024)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         NetworkMask;                                       // 0x0130(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMovieSceneEntitySystemGraph           SystemGraph;                                       // 0x02A8(0x0150)(NativeAccessSpecifierPublic)
	uint8                                         Pad_3F8[0x308];                                    // 0x03F8(0x0308)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UObject*                                AnimatedObject;                                    // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
