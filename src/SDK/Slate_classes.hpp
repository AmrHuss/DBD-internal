...
// 0x0E88 (0x0EC0 - 0x0038)
class UEditableTextBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0040(0x0E80)(Edit, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0040(0x02F0)(Edit, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0040(0x0340)(Edit, NativeAccessSpecifierPublic)
