...
// class AKiller**                         SlasherPlayer                                          (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_Pallet_C::GetAssociatedKiller(class ADBDPlayer* DBDPlayer, class AKiller** SlasherPlayer)
{
	static class UFunction* Func = nullptr;
...
void ABP_Pallet_C::ExplodeVfxSfx()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Pallet_C", "ExplodeVfxSfx");
