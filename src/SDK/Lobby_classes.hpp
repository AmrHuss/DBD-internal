...
public:
	...
	TSoftClassPtr<class UClass>                   LobbyStateClass;                                   // 0x02D8(0x0038)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ALobbyBeaconState*                      LobbyState;                                        // 0x0310(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_3E0[0x68];                                     // 0x03E0(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
