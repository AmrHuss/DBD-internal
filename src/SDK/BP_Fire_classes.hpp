...
public:
	void Spawn(class UParticleSystemComponent* Spawn_0, double Smoke1, double Smoke2, double F_Smoke2, double Fire0, double F_Fire0, double Flames1, double Flames2, double Flames3, double F_Flames1, double F_Flames2, double F_Flames3);
