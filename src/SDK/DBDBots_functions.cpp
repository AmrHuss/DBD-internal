...
// Function DBDBots.AISkill_Interaction_InLocker.OnLevelReadyToPlay
// (Final, Native, Private)

void UAISkill_Interaction_InLocker::OnLevelReadyToPlay()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AISkill_Interaction_InLocker", "OnLevelReadyToPlay");
