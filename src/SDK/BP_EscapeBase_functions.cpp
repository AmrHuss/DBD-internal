...
// Function BP_EscapeBase.BP_EscapeBase_C.TML_LightsFlickerControl__UpdateFunc
// (BlueprintEvent)

void ABP_EscapeBase_C::TML_LightsFlickerControl__UpdateFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EscapeBase_C", "TML_LightsFlickerControl__UpdateFunc");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_EscapeBase.BP_EscapeBase_C.TML_LightsFlickerControl__FinishedFunc
// (BlueprintEvent)

void ABP_EscapeBase_C::TML_LightsFlickerControl__FinishedFunc()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EscapeBase_C", "TML_LightsFlickerControl__FinishedFunc");
...
// Parameters:
// bool                                    isCurrentlyDecharging                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    isSurvivor                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_EscapeBase_C::Cosmetic_OnSpectatedPlayerChanged(bool isCurrentlyDecharging, bool isSurvivor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EscapeBase_C", "Cosmetic_OnSpectatedPlayerChanged");

	Params::BP_EscapeBase_C_Cosmetic_OnSpectatedPlayerChanged Parms{};
...
// Function BP_EscapeBase.BP_EscapeBase_C.Cosmetic_OnGateDechargeEnd
// (BlueprintCosmetic, Event, Protected, BlueprintEvent)

void ABP_EscapeBase_C::Cosmetic_OnGateDechargeEnd()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EscapeBase_C", "Cosmetic_OnGateDechargeEnd");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_EscapeBase.BP_EscapeBase_C.Cosmetic_OnGateDechargeBegin
// (BlueprintCosmetic, Event, Protected, BlueprintEvent)

void ABP_EscapeBase_C::Cosmetic_OnGateDechargeBegin()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EscapeBase_C", "Cosmetic_OnGateDechargeBegin");
