...
// Parameters:
// const struct FVector&                   VectorToReflect                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
TArray<class USceneComponent*> ABP_SmallMeatLocker_C::GetSnapPointsArray() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SmallMeatLocker_C", "GetSnapPointsArray");

	Params::BP_SmallMeatLocker_C_GetSnapPointsArray Parms{};
...
// Parameters:
// const class FName                       NoiseRangeTunable                                      (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const class ADBDPlayer*                 soundInstigator                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
