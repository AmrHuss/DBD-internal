...
public:
	bool AddBooleanAttribute(const class FName& NodeAttributeKey, const bool& Value);
	bool AddDoubleAttribute(const class FName& NodeAttributeKey, const double& Value);
	bool AddFloatAttribute(const class FName& NodeAttributeKey, const float& Value);
	bool AddGuidAttribute(const class FName& NodeAttributeKey, const struct FGuid& Value);
	bool AddInt32Attribute(const class FName& NodeAttributeKey, const int32& Value);
	bool AddLinearColorAttribute(const class FName& NodeAttributeKey, const struct FLinearColor& Value);
	bool AddStringAttribute(const class FName& NodeAttributeKey, const class FString& Value);
	bool AddVector2Attribute(const class FName& NodeAttributeKey, const struct FVector2f& Value);
	...
	bool RemoveAttribute(const class FName& NodeAttributeKey);
	...
	bool GetBooleanAttribute(const class FName& NodeAttributeKey, bool* OutValue) const;
	class FString GetDisplayLabel() const;
	bool GetDoubleAttribute(const class FName& NodeAttributeKey, double* OutValue) const;
	bool GetFloatAttribute(const class FName& NodeAttributeKey, float* OutValue) const;
	bool GetGuidAttribute(const class FName& NodeAttributeKey, struct FGuid* OutValue) const;
	bool GetInt32Attribute(const class FName& NodeAttributeKey, int32* OutValue) const;
	bool GetLinearColorAttribute(const class FName& NodeAttributeKey, struct FLinearColor* OutValue) const;
	EInterchangeNodeContainerType GetNodeContainerType() const;
	class FString GetParentUid() const;
	bool GetStringAttribute(const class FName& NodeAttributeKey, class FString* OutValue) const;
	...
	bool GetVector2Attribute(const class FName& NodeAttributeKey, struct FVector2f* OutValue) const;
...
// 0x0000 (0x0068 - 0x0068)
class UInterchangeResultSuccess final : public UInterchangeResult
{
public:
	static class UClass* StaticClass()
	{
...
// Class InterchangeCore.InterchangeAnimationAPI
// 0x0000 (0x0030 - 0x0030)
class UInterchangeAnimationAPI final : public UObject
{
public:
	static bool GetCustomIsNodeTransformAnimated(const class UInterchangeBaseNode* InterchangeBaseNode, bool* AttributeValue);
	static bool GetCustomNodeTransformAnimationEndTime(const class UInterchangeBaseNode* InterchangeBaseNode, double* AttributeValue);
	static bool GetCustomNodeTransformAnimationKeyCount(const class UInterchangeBaseNode* InterchangeBaseNode, int32* AttributeValue);
	static bool GetCustomNodeTransformAnimationStartTime(const class UInterchangeBaseNode* InterchangeBaseNode, double* AttributeValue);
	static bool GetCustomNodeTransformPayloadKey(const class UInterchangeBaseNode* InterchangeBaseNode, class FString* AttributeValue);
	static bool SetCustomIsNodeTransformAnimated(class UInterchangeBaseNode* InterchangeBaseNode, const bool& AttributeValue);
	static bool SetCustomNodeTransformAnimationEndTime(class UInterchangeBaseNode* InterchangeBaseNode, const double& AttributeValue);
	static bool SetCustomNodeTransformAnimationKeyCount(class UInterchangeBaseNode* InterchangeBaseNode, const int32& AttributeValue);
	static bool SetCustomNodeTransformAnimationStartTime(class UInterchangeBaseNode* InterchangeBaseNode, const double& AttributeValue);
	static bool SetCustomNodeTransformPayloadKey(class UInterchangeBaseNode* InterchangeBaseNode, const class FString& AttributeValue);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InterchangeAnimationAPI">();
	}
	static class UInterchangeAnimationAPI* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInterchangeAnimationAPI>();
	}
};
