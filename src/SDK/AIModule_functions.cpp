...
void UAISense_Hearing::Authority_ReportNoiseEventBHVR(class AActor* instigatingActor, const struct FVector& NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, class FName Tag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AISense_Hearing", "Authority_ReportNoiseEventBHVR");

	Params::AISense_Hearing_Authority_ReportNoiseEventBHVR Parms{};
