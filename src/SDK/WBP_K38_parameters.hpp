...
struct WBP_K38_C_SetKillerData final
{
public:
...
struct WBP_K38_C_Set_K38Data final
{
public:
	class UK38StatusData*                         ViewData;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct WBP_K38_C_ExecuteUbergraph_WBP_K38 final
{
public:
	...
	class UK38StatusData*                         K2Node_DynamicCast_AsK38Status_Data;               // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
