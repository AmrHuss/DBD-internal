...
{
public:
	TSubclassOf<class UGeneratorBlastMinePlacerComponent> _blastMinePlacerClass;                     // 0x04E8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class ABlastMineFirecracker>      _blastMineFirecrackerClass;                        // 0x04F0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ABlastMineFirecracker*                  _blastMine;                                        // 0x04F8(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
// Class TheS26.BlastMineExplosiveActorEffect
// 0x0008 (0x0038 - 0x0030)
class UBlastMineExplosiveActorEffect final : public UBlindAndDeafenRangedExplosiveActorEffect
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"BlastMineExplosiveActorEffect">();
	}
	static class UBlastMineExplosiveActorEffect* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBlastMineExplosiveActorEffect>();
	}
};
...
public:
	...
	TMulticastInlineDelegate<void(EBlastMineRemovedReason removedReason)> OnTrapRemovedBlueprintEvent; // 0x0448(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class AKiller*                                _kickingKiller;                                    // 0x00E0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UChargeableComponent*                   _kickGeneratorChargeable;                          // 0x00E8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AGenerator*                             _generator;                                        // 0x00F0(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TSet<class UFXSystemComponent*>               _systems;                                          // 0x0120(0x0050)(ExportObject, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TSet<class UMeshComponent*>                   _meshes;                                           // 0x0170(0x0050)(ExportObject, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
public:
	...
	float                                         _totemAuraVisibleDuration[0x3];                    // 0x0464(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         _startingTotemCleanseSpeedBonus[0x3];              // 0x0470(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         _stackableTotemCleanseSpeedBonus[0x3];             // 0x047C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class ABlastMineFirecracker*                  _blastMine;                                        // 0x00D8(0x0008)(Net, ZeroConstructor, Transient, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	float                                         _healRegainPercentage[0x3];                        // 0x0460(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
