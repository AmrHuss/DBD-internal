...
// 0x0040 (0x0040 - 0x0000)
struct AISense_Hearing_Authority_ReportNoiseEventBHVR final
{
public:
	class AActor*                                 instigatingActor;                                  // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
