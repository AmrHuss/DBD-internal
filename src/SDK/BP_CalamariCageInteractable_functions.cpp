...
// (Event, Protected, BlueprintEvent)
// Parameters:
// const class ASurvivor*                  cagedSurvivor                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_CalamariCageInteractable_C::OnSurvivorDeath(const class ASurvivor* cagedSurvivor)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// bool                                    isAnticampRelocation                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ASurvivor*                        cagedSurvivor                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_CalamariCageInteractable_C::Cosmetic_OnGoingUpStarted(bool isAnticampRelocation, class ASurvivor* cagedSurvivor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CalamariCageInteractable_C", "Cosmetic_OnGoingUpStarted");

	Params::BP_CalamariCageInteractable_C_Cosmetic_OnGoingUpStarted Parms{};
...
// (BlueprintCosmetic, Event, Protected, BlueprintEvent)
// Parameters:
// const bool                              isAnticampRelocation                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const class ASurvivor*                  cagedSurvivor                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_CalamariCageInteractable_C::Cosmetic_OnGoingUpFinished(const bool isAnticampRelocation, const class ASurvivor* cagedSurvivor)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintCosmetic, Event, Protected, BlueprintEvent)
// Parameters:
// const bool                              Display                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const class UInteractor*                Interactor_0                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
bool ABP_CalamariCageInteractable_C::IsInterruptionPossible(const class ADBDPlayer* interruptor, const class ADBDPlayer* interruptee, const class UInteractor* Interactor_0, const class UInteractionDefinition* definition, const class UInterruptionDefinition* interruption) const
{
	static class UFunction* Func = nullptr;
	...
	Parms.Interactor_0 = Interactor_0;
