...
// Parameters:
// class UCameraComponent**                PlayerCam_0                                            (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class ADBDPlayer**                      PlayerPawn_0                                           (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class ADBDPlayerController**            PlayerController_0                                     (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class APlayerCameraManager**            PlayerCameraManager_0                                  (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void AProceduralLevel_C::GetLocalPlayer(class UCameraComponent** PlayerCam_0, class ADBDPlayer** PlayerPawn_0, class ADBDPlayerController** PlayerController_0, class APlayerCameraManager** PlayerCameraManager_0)
{
	static class UFunction* Func = nullptr;
	...
	if (PlayerCam_0 != nullptr)
		*PlayerCam_0 = Parms.PlayerCam_0;

	if (PlayerPawn_0 != nullptr)
		*PlayerPawn_0 = Parms.PlayerPawn_0;

	if (PlayerController_0 != nullptr)
		*PlayerController_0 = Parms.PlayerController_0;

	if (PlayerCameraManager_0 != nullptr)
		*PlayerCameraManager_0 = Parms.PlayerCameraManager_0;
}
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const class APlayerState*               PlayerState                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
