...
public:
	...
	struct FRigVMDrawContainer                    DrawContainer;                                     // 0x0068(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_80[0x18];                                      // 0x0080(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           EventQueue;                                        // 0x0098(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
...
public:
	...
	struct FRigVMGraphFunctionStore               GraphFunctionStore;                                // 0x0388(0x0020)(NativeAccessSpecifierPublic)
...
public:
	...
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0068(0x0090)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMInstructionArray                 Instructions;                                      // 0x0100(0x0010)(Transient, NativeAccessSpecifierPrivate)
	struct FRigVMExtendedExecuteContext           Context;                                           // 0x0110(0x0108)(Transient, Protected, NativeAccessSpecifierProtected)
	uint32                                        NumExecutions;                                     // 0x0218(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_21C[0x4];                                      // 0x021C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           FunctionNamesStorage;                              // 0x0220(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_230[0x38];                                     // 0x0230(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigVMParameter>                Parameters;                                        // 0x0268(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                      ParametersNameMap;                                 // 0x0278(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C8[0xF0];                                     // 0x02C8(0x00F0)(Fixing Size After Last Property [ Dumper-7 ])
	class URigVM*                                 DeferredVMToCopy;                                  // 0x03B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
