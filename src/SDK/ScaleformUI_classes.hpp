...
public:
	...
	TMulticastInlineDelegate<void(const class FString& Cmd, const class FString& Arg)> OnFsCommand;  // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnStartCommand;                                    // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnCloseCommand;                                    // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float DeltaTime)> OnTickCommand;                                   // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(int32 LocalPlayerIndex)> OnFocusGainedCommand;                     // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(int32 LocalPlayerIndex)> OnFocusLostCommand;                       // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	struct FASValue Invoke(const class FString& MovieClipName, const class FString& FunctionName, const TArray<struct FASValue>& params);
...
public:
	...
	struct FASValue Invoke(const class FString& FunctionName, const TArray<struct FASValue>& params);
...
public:
	...
	static struct FASValue Invoke(class UGFxMoviePlayer* MoviePlayer, const class FString& FunctionName, const TArray<struct FASValue>& params);
