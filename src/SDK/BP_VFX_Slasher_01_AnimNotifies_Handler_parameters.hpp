...
struct BP_VFX_Slasher_01_AnimNotifies_Handler_C_HandleAnimNotify final
{
public:
	...
	bool                                          CallFunc_HandleKillerNotifies_General_ReturnValue; // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
