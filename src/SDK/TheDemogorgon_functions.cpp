...
void UDemogorgonHuskAnimInstance::OnKillerSet(class AKiller* Killer)
{
...
void UDemogorgonPortalPlacerStateComponent::InitializeTunableValues(class AKiller* Killer)
{
	static class UFunction* Func = nullptr;
...
// Function TheDemogorgon.DemogorgonPounceInteraction.Server_InformQatarDashTriggered
// (Final, Net, NetReliable, Native, Event, Private, NetServer)

void UDemogorgonPounceInteraction::Server_InformQatarDashTriggered()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DemogorgonPounceInteraction", "Server_InformQatarDashTriggered");
...
void UTeleportToDemogorgonPortalInteraction::OnKillerSet(class AKiller* Killer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TeleportToDemogorgonPortalInteraction", "OnKillerSet");

	Params::TeleportToDemogorgonPortalInteraction_OnKillerSet Parms{};
