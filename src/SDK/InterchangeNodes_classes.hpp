...
public:
	...
	bool SetCustomAnimationPayloadKey(const class FString& PayloadKey);
	...
	bool GetCustomAnimationPayloadKey(class FString* PayloadKey) const;
...
public:
	bool RemoveAnimationPayloadKeyForMorphTargetNodeUid(const class FString& MorphTargetNodeUid);
	bool RemoveAnimationPayloadKeyForSceneNodeUid(const class FString& SceneNodeUid);
	bool SetAnimationPayloadKeyForMorphTargetNodeUid(const class FString& MorphTargetNodeUid, const class FString& PayloadKey);
	bool SetAnimationPayloadKeyForSceneNodeUid(const class FString& SceneNodeUid, const class FString& PayloadKey);
	...
	bool SetCustomSkeletalMeshNodeUid(const class FString& AttributeValue);
	bool SetCustomSkeletonNodeUid(const class FString& AttributeValue);

	bool GetAnimationPayloadKeyFromMorphTargetNodeUid(const class FString& MorphTargetNodeUid, class FString* OutPayloadKey) const;
	bool GetAnimationPayloadKeyFromSceneNodeUid(const class FString& SceneNodeUid, class FString* OutPayloadKey) const;
	...
	bool GetCustomSkeletalMeshNodeUid(class FString* AttributeValue) const;
	bool GetCustomSkeletonNodeUid(class FString* AttributeValue) const;
	void GetMorphTargetNodeAnimationPayloadKeys(TMap<class FString, class FString>* OutMorphTargetNodeAnimationPayloads) const;
	void GetSceneNodeAnimationPayloadKeys(TMap<class FString, class FString>* OutSceneNodeAnimationPayloadKeys) const;
...
// Class InterchangeNodes.InterchangeCameraNode
// 0x0030 (0x0098 - 0x0068)
class UInterchangeCameraNode final : public UInterchangeBaseNode
{
public:
	uint8                                         Pad_68[0x30];                                      // 0x0068(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InterchangeCameraNode">();
	}
	static class UInterchangeCameraNode* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInterchangeCameraNode>();
	}
};
...
public:
	...
	void SetAnimationCurvePayLoadKey(const class FString& PayloadKey);
...
{
public:
	uint8                                         Pad_68[0x228];                                     // 0x0068(0x0228)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static bool ConnectOuputToInput(class UInterchangeBaseNode* InterchangeNode, const class FString& InputName, const class FString& ExpressionUid, const class FString& OutputName);
	...
	static class FName MakeInputConnectionKey(const class FString& InputName);
	static class FString MakeInputName(const class FString& InputKey);
	static class FName MakeInputValueKey(const class FString& InputName);
...
class UInterchangeTexture2DNode final : public UInterchangeTextureNode
{
public:
