...
// ScriptStruct DBDProceduralCamera.ShotByRank
// 0x0018 (0x0018 - 0x0000)
struct FShotByRank final
{
public:
	class UProceduralCameraShotData*              SelectedShot;                                      // 0x0000(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UProceduralCameraShotData*>      Shots;                                             // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
