...
public:
	...
	TSoftClassPtr<class UClass>                   PipelineConfigurationDialogClass;                  // 0x0060(0x0038)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowPipelineStacksConfigurationDialog;            // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TMap<EInterchangeTranslatorAssetType, class FName> DefaultPipelineStackOverride;                 // 0x00A0(0x0050)(Edit, NativeAccessSpecifierPublic)
	TMap<EInterchangeTranslatorAssetType, bool>   ShowPipelineStacksConfigurationDialogOverride;     // 0x00F0(0x0050)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class UInterchangePipelineBase*>       OverridePipelines;                                 // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
