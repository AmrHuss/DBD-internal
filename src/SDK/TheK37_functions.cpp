...
// (BlueprintCosmetic, Event, Protected, BlueprintEvent)
// Parameters:
// const float                             progressPercentage                                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class AActor*                           TargetActor                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void AK37FlamePillar::Cosmetic_OnFlamePillarHit(class ASurvivor* Survivor)
{
	static class UFunction* Func = nullptr;
...
void AK37FlamePillar::Multicast_HitSurvivor(class ASurvivor* Survivor)
{
	static class UFunction* Func = nullptr;
...
void UK37P01::Authority_OnObsessionChanged(class ASurvivor* newObsession, class ASurvivor* previousObsession)
{
	static class UFunction* Func = nullptr;
