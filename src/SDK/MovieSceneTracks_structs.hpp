...
{
public:
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x0040(0x0110)(NativeAccessSpecifierPublic)
	EMovieSceneBlendType                          BlendType;                                         // 0x0480(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0040(0x0140)(NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x0040(0x0110)(Protected, NativeAccessSpecifierProtected)
};
