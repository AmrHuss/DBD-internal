...
void UWBP_CoreSpectateBar_C::SetSpectateBarVisibility(const bool IsVisible_0)
{
	static class UFunction* Func = nullptr;
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const bool                              IsBot                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_CoreSpectateBar_C::SetArrowsVisibility(const bool IsVisible_0)
{
	static class UFunction* Func = nullptr;
