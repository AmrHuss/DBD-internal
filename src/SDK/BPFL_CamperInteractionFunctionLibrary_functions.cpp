...
void UBPFL_CamperInteractionFunctionLibrary_C::GetCamperOwner(class UInteractionDefinition* InteractionDefinition, class UObject* __WorldContext, class ASurvivor** Camper)
{
