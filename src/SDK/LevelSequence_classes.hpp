...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x02A8(0x00D8)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
{
public:
	TMulticastInlineDelegate<void(class UCameraComponent* CameraComponent)> OnCameraCut;             // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D0[0x130];                                    // 0x04D0(0x0130)(Fixing Struct Size After Last Property [ Dumper-7 ])
