...
void ABP_Slasher_Character_C::UpdateEndGameCollapseVFX()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Slasher_Character_C", "UpdateEndGameCollapseVFX");
...
void ABP_Slasher_Character_C::Dissolve(bool Param_Dissolve_0)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintEvent)
// Parameters:
// const class UFlashlightComponent*       Flashlight                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
