...
public:
	...
	TMap<class FString, class UTexture2D*>        TooltipEventSkinUIDataMap;                         // 0x01C8(0x0050)(Transient, NativeAccessSpecifierPublic)
	TMap<class FString, struct FAlertRewardEventSkinData> AlertRewardEventSkinUIDataMap;             // 0x0218(0x0050)(Transient, NativeAccessSpecifierPublic)
	TMap<EChallengeSetType, struct FChallengeTrackerSkinData> ChallengeTrackerSkinUiDataMap;         // 0x0268(0x0050)(Transient, NativeAccessSpecifierPublic)
	TMap<class FString, struct FInboxSkinUIData>  InboxSkinUiDataMap;                                // 0x02B8(0x0050)(Transient, NativeAccessSpecifierPublic)
...
public:
	...
	struct FAlertRewardEventSkinData GetAlertRewardEventSkinData(const class FString& EventThemeLabel) const;
	...
	struct FInboxSkinUIData GetInboxSkinUIData(const class FString& inboxSkinLabel) const;
	TMap<struct FKey, struct FInputPromptDataRow> GetInputPromptControlModeData(const EControlMode controlMode) const;
	TSoftObjectPtr<class UMaterialInterface> GetLoadoutPartRarityMaterial(EItemRarity Rarity, ELoadoutSlot slotIndex) const;
	TSoftObjectPtr<class UMaterialInterface> GetLoadoutPartStatusEffectMaterial(EStatusEffectType StatusEffect, ELoadoutSlot slotIndex) const;
	TSoftObjectPtr<class UTexture2D> GetProgressionIcon(const EProgressionType ProgressionType) const;
	struct FLinearColor GetRarityTextColor(EItemRarity Rarity) const;
...
{
public:
	uint8                                         Pad_38[0x310];                                     // 0x0038(0x0310)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(const class FString& ID, const struct FGeometry& Geometry)> OnDrawScaleformBlockingArea; // 0x0348(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& ID)> OnRemoveScaleformBlockingArea;           // 0x0358(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
