...
void USurvivorExposerAnalyticsComponent::OnSurvivorExposerDespawned(const struct FGameplayTag& gameEventType, const struct FGameEventData& GameEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SurvivorExposerAnalyticsComponent", "OnSurvivorExposerDespawned");

	Params::SurvivorExposerAnalyticsComponent_OnSurvivorExposerDespawned Parms{};
...
void USurvivorExposerAnalyticsComponent::OnSurvivorExposerSpawned(const struct FGameplayTag& gameEventType, const struct FGameEventData& GameEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SurvivorExposerAnalyticsComponent", "OnSurvivorExposerSpawned");

	Params::SurvivorExposerAnalyticsComponent_OnSurvivorExposerSpawned Parms{};
