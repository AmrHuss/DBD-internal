...
public:
	...
	static void Audio_Footstep_GetMaterial(class UAkComponent* AkComponent, class AActor* Player, class UObject* __WorldContext);
	...
	static void Audio_Survivor_Dialogue_Stop(class ADBDBasePlayer* Player, class UObject* __WorldContext);
